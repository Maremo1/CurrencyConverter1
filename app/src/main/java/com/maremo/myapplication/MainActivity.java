package com.maremo.myapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    String[] country = {"USD", "ZAR", "BDT", "PKR", "INR"};
    ...
    public String getConversionRate(String convertFrom, String convertTo, Double amountToConvert){
        ...
        String url = "https://freecurrencyapi.net/api/v2/latest"+convertFrom+"_"+convertTo+"&compact=ultra&apikey=f7d08fe0-79f8-11ec-8f44-ab314725a47a";
